...
export function createEmptyDocument(): VectorDocument {
  return { version: 1, units: "mm", revision: 0, paths: [], pathOrder: [] };
}
...
export function commitDocument(current: VectorDocument, paths: VectorPath[], pathOrder = current.pathOrder): VectorDocument {
